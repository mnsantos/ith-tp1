...
form Save intervals to small WAV sound files
	...
	boolean Exclude_intervals_labeled_as_# 1
...
for interval from start_from to end_at
	...
	if xxx$ = "xxx" and exclude_intervals_labeled_as_# = 1
		check = 1
	endif
...
for interval from start_from to end_at
	...
	if intname$ = "xxx" and exclude_intervals_labeled_as_# = 1
		check = 1
	endif
